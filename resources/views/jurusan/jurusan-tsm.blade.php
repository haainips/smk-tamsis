...
@section('content')
    ...
    <div class="flex justify-center gap-10 py-20">
        ...
        <div class="leading-tight space-y-4 w-1/2">
            <h1 class="text-4xl font-title font-semibold">Kompetensi Keahlian Teknik Sepeda Motor</h1>
            <p class="font-subtitle text-xl text-justify">Adalah program keahlian dalam bidang teknik otomotif yang berfokus pada perawatan, perbaikan, dan modifikasi sepeda motor. Jurusan ini membekali siswa dengan keterampilan praktis dalam menangani berbagai jenis kendaraan roda dua, baik dari aspek mekanik, kelistrikan, hingga sistem injeksi.</p>
        </div>
    </div>
