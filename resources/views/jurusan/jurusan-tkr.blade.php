...
@section('content')
    ...
    <div class="flex gap-10 py-20 justify-center">
        ...
        <div class="leading-tight space-y-4 w-1/2">
            <h1 class="text-4xl font-title font-semibold">Kompetensi Keahlian Teknik Kendaraan Ringan</h1>
            <p class="font-subtitle text-xl text-justify">Adalah program keahlian yang fokus pada pemeliharaan, perbaikan, dan perawatan kendaraan ringan, seperti mobil. Jurusan ini mempelajari sistem otomotif, termasuk mesin, kelistrikan, sasis, dan transmisi kendaraan.</p>
        </div>
    </div>
