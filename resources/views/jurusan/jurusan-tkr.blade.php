...
@section('content')
    ...
    <div class="flex flex-col md:flex-row gap-6 md:gap-10 py-12 md:py-20 max-w-7xl mx-auto px-10">
        <img src="{{ asset('images/tkr.png') }}" alt="" class="rounded-xl h-44 md:h-70 w-full md:w-auto object-cover">
    ...
    <div class="flex flex-col md:flex-row gap-8 md:gap-10 py-10 lg:px-10 px-20">
        <!-- VISI -->
        <div class="md:w-1/2">
