...
@section('content')
    ...
    <div class="flex justify-center gap-10 py-20">
        ...
        <div class="leading-tight space-y-4 w-1/2">
            <h1 class="text-4xl font-title font-semibold">Kompetensi Keahlian Desain Komunikasi Visual</h1>
            <p class="font-subtitle text-xl text-justify">Adalah program keahlian yang berfokus pada pembelajaran desain grafis, ilustrasi, animasi, fotografi, dan media komunikasi visual lainnya. Jurusan ini membekali siswa dengan keterampilan dalam menciptakan karya visual yang efektif untuk berbagai kebutuhan industri kreatif, seperti periklanan, media sosial, branding, dan multimedia.</p>
        </div>
    </div>
