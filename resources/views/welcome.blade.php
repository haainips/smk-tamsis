...
@section('content')
    ...
    @include('components.slider')
        ...
        <div class="flex gap-16 px-6 py-8">
            <img src="{{asset('images/landing-image1.svg')}}" alt="" class="w-[518px]">
            <div>
                ...
                <p class="text-justify text-xl mt-2 font-subtitle">Selamat datang di website SMK Tamansiswa Jetis Yogyakarta. Dalam perkembangan era glob alisasi dan pesatnya kemajuan
                teknologi dan informasi ini, tidak dapat dipungkiri bahwa keberadaan sebuah website untuk dunia pendidikan khususnya
                sekolah, sangatlah penting. Media website dapat digunakan sebagai penyedia sarana dalam menyebarluaskan informasi dan
                perkembangan terkini dari sekolah kepada orang tua dan masyarakat, yang memang harus diketahui oleh setiap stakeholder
                secara riil. Disamping itu, website juga dapat menjadi ajang promosi sekolah yang cukup efektif. Berbagai kegiatan
                kemajuan sekolah dapat diinformasikan, disertai data maupun gambar yang relevan, sehingga masyarakat dapat mengetahui
        ...
        <div class="grid grid-cols-3 gap-10 pb-8 px-10 justify-center">
            {{-- Card 1 --}}
            <div class="flex justify-center py-4 px-8 gap-7 bg-secondary rounded-4xl drop-shadow-default hover:bg-black border-b-2 border-white">
                ...
                <div class="leading-tight">
                    <h1 class="text-white font-subtitle font-semibold text-3xl">PPDB Online Pendaftaran <br> peserta didik <br> baru</h1>
                </div>
            </div>
            ...
            <div class="flex justify-center py-4 px-8 gap-7 bg-secondary rounded-4xl drop-shadow-default hover:bg-black border-b-2 border-white">
                ...
                <div class="leading-tight">
                    <h1 class="text-white font-subtitle font-semibold text-3xl">Ikatan Alumni<br>dan Bursa<br>Lowongan<br>Kerja</h1>
                </div>
            </div>
            ...
            <div class="flex justify-center py-4 px-8 gap-7 bg-secondary rounded-4xl drop-shadow-default hover:bg-black border-b-2 border-white">
                ...
                <div class="flex items-center">
                    <h1 class="text-white font-subtitle font-semibold text-3xl">E - Perpus <br> Online</h1>
                </div>
            </div>
        </div>
    ...
    <hr class="border-t-2 mt-8 border-primary">
