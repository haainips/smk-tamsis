...
@section('title', 'Program Kerja Waka Kesiswaan - SMK Tamansiswa Jetis Yogyakarta')
    ...
    <div class="flex flex-col py-10">
        <div class="md:flex px-10 justify-center">
            <div class="space-y-3">
                <div class="relative w-96 flex-shrink-0">
                    <!-- Vector backgrounds -->
                    <img src="{{ asset('images/Vector.png') }}" alt="vector1" class="absolute w-17 top-10 left-24 md:left-16 ">
                    <img src="{{ asset('images/vector-1.png') }}" alt="vector2" class="absolute w-44 top-18 left-40 md:left-32">

                    <!-- Profile Photo -->
                    <img src="{{ asset('images/kesiswaan.png') }}" alt="Waka Kurikulum"
                        class="relative z-10 object-cover left-28 md:left-24" width="190px">
                </div>
            ...
            <div class="flex flex-col justify-center mt-16 md:w-1/2">
                <span class="">
                    <h1 class="font-title text-2xl md:text-3xl font-semibold text-center md:text-start">PROGRAM KERJA WAKA KESISWAAN</h1>
                    <p class="font-subtitle text-lg md:text-xl pt-8 text-justify">Wakil Kepala Sekolah Bidang Kesiswaan (Waka
        ...
        <div class="max-w-6xl mx-auto pt-14">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-20">
                <!-- Column 1 -->
                <div class="space-y-3 px-10 md:px-10">
                    <!-- Item 1 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-6">1.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">Program pembinaan PPTS/OSIS mencakup :</p>
                    </div>
                    <ul class="list-disc text-justify ml-10 font-subtitle text-lg md:text-xl space-y-2">
                ...
                <div class="space-y-3 px-10 md:px-10">
                    <!-- Item 6 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-6">2.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">Program Pembinaan Ekstrakurikuler</p>
                    </div>
                    <ul class="list-disc text-justify ml-10 font-subtitle text-lg md:text-xl space-y-2">
                    ...
                    <div class="flex items-start mt-8">
                        <span class="font-subtitle text-lg md:text-xl mr-6">3.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">
