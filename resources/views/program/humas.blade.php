...
@section('content')
    ...
    <div class="flex flex-col py-10">
        <div class="md:flex px-10 justify-center">
            <div class="space-y-3">
                <div class="relative w-96 flex-shrink-0">
                    ...
                    <img src="{{ asset('images/humas.png') }}" alt="Waka Kurikulum"
                        class="relative z-10 object-cover left-18 md:left-10 " width="280px">
                </div>
            ...
            <div class="flex flex-col justify-center md:w-1/2 pt-10 md:pt-0">
                <span class="">
                    <h1 class="font-title text-center md:text-start text-2xl md:text-3xl font-semibold">PROGRAM KERJA WAKA HUMAS</h1>
                    <p class="font-subtitle text-lg md:text-xl pt-8 text-justify">Pelaksanaan Praktek Kerja Lapangan (PKL) sebagai
        ...
        <div class="max-w-6xl mx-auto pt-14 px-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-20">
                <!-- Column 1 -->
                <div class="space-y-6">
                    <!-- Item 1 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-4">1.</span>
                    ...
                    <!-- Item 2 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-4">2.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">
                    ...
                    <!-- Item 3 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-4">3.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">
                ...
                <div class="space-y-6">
                    <!-- Item 6 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-4">6.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">
                    ...
                    <!-- Item 7 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-4">7.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">
                    ...
                    <!-- Item 8 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-4">8.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">
                    ...
                    <!-- Item 9 -->
                    <div class="flex items-start">
                        <span class="font-subtitle text-lg md:text-xl mr-4">9.</span>
                        <p class="font-subtitle text-lg md:text-xl text-justify">
