...
@section('content')
    ...
    <div class="flex px-10 justify-center pb-20">
        <div>
            ...
            <span class="text-center text-xl font-subtitle">
        ...
        <div class="flex flex-col justify-center mt-16 w-1/2">
            ...
            <ol class="py-4 space-y-2 list-decimal list-inside font-subtitle text-xl mt-10">
                ...
                <li>
                    ...
                    <ul class="ml-8 mt-2 space-y-2 list-[upper-alpha] list-inside">
