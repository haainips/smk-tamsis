...
@section('content')
    ...
    <div class="max-w-6xl mx-auto pt-10 text-justify">
        <span class="flex flex-col items-center font-subtitle text-xl leading-tight pt-3 text-justify">
            <h1 class="text-4xl font-title mt-9">VISI</h1>
            <p class="pt-6 text-2xl text-center">“Terwujudnya Sumber Daya Manusia yang beriman dan bertaqwa, cerdas,
                inovatif, serta berdaya saing global”.</p>
            <h1 class="text-4xl font-title pt-20">MISI</h1>
        </span>
