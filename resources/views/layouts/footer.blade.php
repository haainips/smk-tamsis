<footer class="bg-primary text-white px-6 py-4">
    <div id="footer" class=" mx-auto grid md:grid-cols-3 gap-8 py-4">
        ...
        <div class="flex flex-col items-center text-center ">
            <img src="{{ asset('images/icons/logo1.png') }}" alt="Logo" class="h-30 mb-2">
        
            <p class="font-title drop-shadow-default text-xl">SEKOLAH MENENGAH KEJURUAN <br> Tamansiswa Jetis Yogyakarta</p>
        ...
        <div>
            <h2 class="font-bold text-lg mb-4 font-subtitle text-center drop-shadow-default">LINK TERKAIT</h2>
            <div class="space-y-2">
                <a href="#"
                    class="flex gap-3 border bg-secondary font-subtitle border-white rounded-full px-4 py-2 hover:bg-white hover:text-black transition">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2">
                            <path
                                d="m7.7 12.6l-.021.02a2.795 2.795 0 0 0-.044 4.005v0a2.795 2.795 0 0 0 3.936.006l1.455-1.438a3 3 0 0 0 .34-3.866l-.146-.207" />
                            <path
                                d="m16.22 11.12l.136-.14c.933-.953.992-2.46.135-3.483v0a2.597 2.597 0 0 0-3.664-.32L11.39 8.386a3 3 0 0 0-.301 4.3l.031.034" />
                        </g>
                    </svg>
                    E-Rapor SMK
                </a>
        ...
        <div>
            <h2 class="font-subtitle font-bold drop-shadow-default text-lg mb-4">HUBUNGI KAMI</h2>
            <ul class="space-y-2 text-lg font-subtitle">
                <li class="flex gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19.506 7.96A16.03 16.03 0 0 1 7.96 19.506C5.819 20.051 4 18.21 4 16v-1c0-.552.449-.995.999-1.05a10 10 0 0 0 2.656-.639l1.519 1.52a12.05 12.05 0 0 0 5.657-5.657l-1.52-1.52a10 10 0 0 0 .64-2.656C14.005 4.448 14.448 4 15 4h1c2.208 0 4.05 1.819 3.505 3.96" />
                    </svg>
                    0274 - 515836
                </li>
                <li class="flex gap-3">
                ...
                <li class="flex gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 1024 1024">
                        <path fill="currentColor"
                            d="M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32m-32 736H663.9V602.2h104l15.6-120.7H663.9v-77.1c0-35 9.7-58.8 59.8-58.8h63.9v-108c-11.1-1.5-49-4.8-93.2-4.8c-92.2 0-155.3 56.3-155.3 159.6v89H434.9v120.7h104.3V848H176V176h672z" />
                    </svg>
                    SMK TAMASIS JOGJA
                </li>
                <li class="flex gap-3">
    ...
    <hr class="border-t border-white py-1">

    <!-- Footer Bawah -->
    <p class="text-center">© Copyright SMK TAMANSISWA JETIS YK 2025</p>
</footer>