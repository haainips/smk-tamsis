<header>
    <nav class="bg-primary text-white font-racing px-6 py-5 flex items-center justify-between">
        ...
        <div id="mobile-menu"
            ...
            <!-- Tentang -->
            <button class="w-full flex justify-between items-center font-subtitle font-semibold text-md"
            ...
            <div id="tentang-dropdown" class="hidden space-y-1 pl-4">
                <a href="{{ route('kepala-sekolah') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">Sambutan
                    Kepala Sekolah</a>
                <a href="{{ route('sejarah') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">Sejarah</a>
                <a href="{{ route('visi-misi') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">Visi
                    Misi</a>
                <a href="{{ route('struktur-organisasi') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">Struktur
                    Organisasi</a>
            </div>
            ...
            <div id="jurusan-dropdown" class="hidden space-y-1 text-sm pl-4">
                <a href="{{ route('titl') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">TITL</a>
                <a href="{{ route('rpl') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">RPL</a>
                <a href="{{ route('tkr') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">TKR</a>
                <a href="{{ route('dkv') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">DKV</a>
                <a href="{{ route('tsm') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">TSM</a>
            </div>
            ...
            <div id="program-dropdown" class="hidden space-y-1 pl-4">
                <a href="{{ route('kurikulum') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">WK.
                        KURIKULUM</a>
                <a href="{{ route('humas') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">WK.
                        HUMAS</a>
                ...
                <a href="{{ route('sarpras') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">WK.
                        SARPRAS</a>
                <a href="{{ route('ekstrakurikuler') }}"
                    class="block font-subtitle text-sm font-semibold hover:bg-white hover:text-primary rounded-xl px-2 py-2">EKSTRAKURIKULER</a>
            </div>
            <a href="{{ route('berita') }}" class="block font-subtitle font-semibold text-md">Berita</a>
            <a href="{{ route('galeri') }}" class="block font-subtitle font-semibold text-md">Galeri</a>
